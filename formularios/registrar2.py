...
def registrar():
    ...
    Label(pantalla2, text="LLENE PARA REGISTRAR AL CLIENTE",fg="navy",width="300",height="1", font=("calibri", 15)).pack()
    Label(pantalla2,text="").pack()
    Label(pantalla2, text="NOMBRE").pack()
    Label(pantalla2,text="").pack()
    nusuario2_ver = Entry(pantalla2,width=70)
    nusuario2_ver.pack()
    Label(pantalla2).pack()
    Label(pantalla2, text="APELLIDO").pack()
    Label(pantalla2,text="").pack()
    contr2_ver = Entry(pantalla2,width=70)
    contr2_ver.pack()
    Label(pantalla2).pack()
    Label(pantalla2, text="DNI Nº").pack()
    Label(pantalla2,text="").pack()
    dni2_ver = Entry(pantalla2,width=70)
    dni2_ver.pack()
    Label(pantalla2).pack()
    Label(pantalla2, text="DOMICILIO REAL").pack()
    Label(pantalla2,text="").pack()
    domi2_ver = Entry(pantalla2,width=70)
    domi2_ver.pack()
    Label(pantalla2).pack()
    Label(pantalla2, text="EMAIL").pack()
    Label(pantalla2,text="").pack()
    email = Entry(pantalla2,width=70)
    email.pack()
    Label(pantalla2).pack()
    Label(pantalla2, text="TELEFONO O CELULAR").pack()
    Label(pantalla2,text="").pack()
    telefono = Entry(pantalla2,width=70)
    telefono.pack()
    Label(pantalla2).pack()
    Label(pantalla2, text="MES CUOTA").pack()
    Label(pantalla2,text="").pack()
    cuota = Entry(pantalla2,width=70)
    cuota.pack()
    Label(pantalla2,text="").pack()
    Label(pantalla2,text="").pack()
